...
class MainWindow(QWidget):
    ...
    def _createMainProgramPage(self):
        ...
        leftSectionLayout.addWidget(MultipurposeRegister("EDX", "#3099FF", 'Usef for memory, and buffor for some instrucitons like div'))
        leftSectionLayout.addWidget(FunctionalRegisters("ESI", 'orange', "Source Index Register"))
        leftSectionLayout.addWidget(FunctionalRegisters("EDI", 'orange', "Destination Index Register"))
        ...
        leftSectionLayout.addWidget(FunctionalRegisters("EIP", "#CC3F0C", "Instruction Pointer Register"))
